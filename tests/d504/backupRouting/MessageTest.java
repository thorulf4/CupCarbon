...
class MessageTest {
    ...
    @Test
    void serialize() {
        Message message = new Message("5", new DataPackage("a17","1", "hello world"));
        message.receivers.add("3");
        message.receivers.add("5");

        assertEquals("5&a17&1&hello world&3&5", message.serialize());
    }

    @Test
    void deserialize() {
        Message message = Message.deserialize("5&a17&1&hello world&3&5");
